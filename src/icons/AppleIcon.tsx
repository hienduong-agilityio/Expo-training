...
const AppleIcon = ({
  ...
  <Svg width={size} height={size} viewBox="0 0 25 25" fill="none" {...props}>
    <G clipPath="url(#clip0_1_18626)">
      ...
      />
      <Path
        d="M22.4535 8.38746C21.1739 6.78278 19.3754 5.85153 17.677 5.85153C15.4348 5.85153 14.4864 6.92496 12.9286 6.92496C11.3224 6.92496 10.1021 5.85466 8.163 5.85466C6.25832 5.85466 4.23021 7.01871 2.94428 9.00933C1.13648 11.8124 1.44585 17.0827 4.37552 21.5718C5.42395 23.178 6.82395 24.9842 8.65518 24.9999C10.2849 25.0155 10.7442 23.9546 12.952 23.9436C15.1598 23.9311 15.5786 25.0139 17.2051 24.9967C19.0379 24.9827 20.5145 22.9811 21.5629 21.3749C22.3145 20.2233 22.5942 19.6436 23.177 18.3436C18.9379 16.7296 18.2583 10.7015 22.4535 8.38746Z"
        fill={color}
      />
    </G>
    <Defs>
